...
//an interface can either be public or no access modifier (package default)
//Interfaces cannot be instantiated—they can only be implemented by classes or extended by other interfaces.
//an interface can extend more than 1 interface !
//members of an interface cannot be private or protected !
//static blocks and constructors are not allowed in an interface
public interface GenericDrug {
    ...
    //all methods in an interface are public by default. Following are 3 types of method an interface can have :
