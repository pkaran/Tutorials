...
import LanguageCore.Exception_handling;
...
public class Main {
    ...
    private static void oopDemo(){
        ...
        Employee.InnerClass inner = new Employee().new InnerClass();
        //initializing a static inner class instance
        Employee.StaticInnerClass innerStatic = new Employee.StaticInnerClass();
    ...
    private static void exception_handling(){
        ...
        Exception_handling.tryCatch();
        Exception_handling.multipleCatch();
        Exception_handling.nestedTry(null); //will call default handler
        Exception_handling.noHandler();     //this will never be reached
    }
